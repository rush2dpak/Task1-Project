(function (app) {
    ...
    app.directive('scrollableTable', scrollableTable);
    scrollableTable.$inject = ['$timeout', '$q', '$parse']; 

    function scrollableTable($timeout, $q, $parse) {
        return {
            transclude: true,
            restrict: 'E',
            scope: {
    ...
    app.directive('sortableHeader',sortableHeader);
